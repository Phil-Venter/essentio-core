...
//         $arg = Argument::create(["script.php", "--verbose=true"]);
//         expect($arg->command)->toBe("");
...
//         $arg = Argument::create(["script.php", "--output", "file.txt"]);
...
//         $arg = Argument::create(["script.php", "--debug"]);
...
//         $arg = Argument::create(["script.php", "-fvalue"]);
...
//         $arg = Argument::create(["script.php", "-o", "file.txt"]);
...
//         $arg = Argument::create(["script.php", "--debug", "--", "--not-a-flag", "positional"]);
//         expect($arg->arguments)->toHaveKey("debug");
//         expect($arg->arguments["debug"])->toBeTrue();
...
//         $arg = Argument::create(["script.php", "--mode=fast", "command", "positional"]);
